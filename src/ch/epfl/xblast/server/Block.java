...
public enum Block {
     ...
     * 
     * @return <b>true<\b> if and only if the block is free
     *         <b>false</b> otherwise
     */
    ...
    /**
     * Returns true if and only if the block casts a shadow on the board
     * (i.e. if it is a wall).
     * 
     * @return <b>true<\b> if and only if the block is a wall
     *         <b>false</b> otherwise
     */
