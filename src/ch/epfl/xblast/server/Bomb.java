 ...
 * explosions. A bomb explodes if it's fuse length is over, or if the blast of
...
public final class Bomb {
     ...
     * of decreasing numbers of size fuseLengths and all of its other
     * parameters.
     * 
     * Parameters and throws same as the main constructor, except for
     * fuseLengths.
     * 
     * @param ownerId
     * @param position
     * @param fuseLength
     *            number of ticks until the bomb will explode (the length of its
     *            wick)
     * @param range
     * @throws NullPointerException
     * @throws IllegalArgumentException
     ...
     * length is given by the constant Ticks.TICKS_EXPLOSION.
     * 
     * @return
     */
     ...
     *         containing the state at each tick of each particle of the arm of
     *         the explosion.
     */
